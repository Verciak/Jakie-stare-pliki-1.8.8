...
public class Ban
{
    ...
    private void insert() {
        ServerPlugin.getStore().update(false, "INSERT INTO `{P}bans`(`id`, `name`, `admin`, `reason`, `time`, `start`) VALUES (NULL, '" + this.getName() + "','" + this.getAdmin() + "','" + this.getReason() + "','" + this.getTime() + "','" + this.getStart() + "');");
    }
