...
package pl.virtual.api.mysql.store.modes;
...
import pl.virtual.api.utils.Timming;
...
public class StoreSQLITE implements Store
{
    ...
    public boolean connect() {
        ...
        try {
            ...
            this.conn = DriverManager.getConnection("jdbc:sqlite:" + ServerPlugin.getPlugin().getDataFolder() + File.separator + Config.DATABASE_SQLITE_NAME);
